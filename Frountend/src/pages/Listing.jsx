    ...
    <main>
      ...
      {listingdata && !loading && !error && (
        <div>
          ...
          <div className=" fixed top-[20%] right-[3%] z-10 border rounded-full h-12 w-12 flex justify-center items-center bg-slate-200 cursor-pointer">
            {" "}
            {/*this will copy the link in clipboard*/}
            <FaShare
          ...
          <div className="flex flex-col max-w-4xl mx-auto p-3 my-7 gap-4">
            ...
            <div className="flex gap-4 ">
              <p className="bg-red-900 w-full max-w-[200px] p-1 text-white text-center rounded-md">
            ...
            <p className="text-slate-800">
              <span className="font-semibold text-black">Discription - </span>
            ...
            {!currentUser && (
              <Link
                to={"/login"}
                className="uppercase bg-gradient-to-r from-[#147d6c] to-[#14a390] text-white text-center p-3 
              rounded-lg hover:bg-gradient-to-r hover:from-[#14a390] hover:to-[#147d6c] w-full disabled:opacity-80"
              >
                Contect landlord
              </Link>
